...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function plot_entropy(Sm,Ds,DS,increment_bin,save_path)
...
%    savefig(h,fullfile(save_path,'entropy_plot.fig'),'compact')
% end

if ischar(save_path)
    savefig(h,fullfile(save_path,'entropy_plot.fig'),'compact')
    for a = 1:length(h)
        exportgraphics(h(a),fullfile(save_path,sprintf('entropy_plot_%d.png', a)))
    end
end
