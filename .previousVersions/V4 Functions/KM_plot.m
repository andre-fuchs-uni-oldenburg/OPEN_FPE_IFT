...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function KM_plot(co,evaluated,Fs,taylor_L,int_L,multi_point,condition,norm_ur,norm_r,save_path)
...
hold on
surf(tmp_u,tmp_r,(co.a(1).*tmp_r.^co.ea(1)+co.a(2)).*tmp_u,'EdgeColor','none')
% surf(tmp_u,tmp_r,((-0.36.*tmp_r.^(-1)).*tmp_u),'FaceColor',[0.8500    0.3250    0.0980])
%Renner
...
if ischar(save_path)
    savefig(h,fullfile(save_path,'KM_opti.fig'),'compact')
    for a = 1:length(h)
        exportgraphics(h(a),fullfile(save_path,sprintf('KM_opti_%d.png', a)))
    end
end
