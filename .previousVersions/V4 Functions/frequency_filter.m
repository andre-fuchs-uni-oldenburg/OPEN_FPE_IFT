...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
function [tmps,x_achse_f_spektrum_filter,spek_smooth_filter,x_achse_k_spektrum_2pi_filter,E_k,x_achse_spektrum_meter_filter,Dr_avg_filter,Dk_avg_filter] = frequency_filter(data, Fs, low_freq,kin_vis,filter,save_path)
...
% savefig(fullfile(save_path,'spectrum_filter.fig'),'compact')
fig_setup
...
if ischar(save_path)
   % savefig(fullfile(save_path,'spectrum_var_domain.fig'))
%    savefig(h,fullfile(save_path,'spectrum_filter.fig'),'compact')
%    for a = 1:length(h)
       exportgraphics(h(1),fullfile(save_path,sprintf('spectrum_filter_%d.png', 1)))
%        export_fig(h(a), fullfile(save_path,sprintf('spectrum_filter_%d.png', a)));
%    end
end
...
if ischar(save_path)
   ...
   savefig(h,fullfile(save_path,'spectrum_filter.fig'),'compact')
%    for a = 1:length(h)
       exportgraphics(h(2),fullfile(save_path,sprintf('spectrum_filter_%d.png', 2)))
%        export_fig(h(a), fullfile(save_path,sprintf('spectrum_filter_%d.png', a)));
%    end
end
close all
