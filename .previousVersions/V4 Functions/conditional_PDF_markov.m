...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function conditional_PDF_markov(data,Fs,m_data,markov,second_condi,num_bin,min_events,norm_ur,save_path)
...
fig_setup
if ischar(save_path)
    savefig(fig,fullfile(save_path,'con_PDF.fig'),'compact')
    for a = 1:length(fig)
        exportgraphics(fig(a),fullfile(save_path,sprintf('con_PDF_%d.png', a)))
    end
end
