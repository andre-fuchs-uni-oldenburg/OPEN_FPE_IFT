...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
function [tmps,x_achse_k_spektrum_2pi_filter,E_k,x_achse_spektrum_meter_filter,Dr_avg_filter,Dk_avg_filter] = frequency_filter(data, Fs, low_freq,kin_vis,filter,save_path)
...
x_achse_spektrum_meter_filter = m_data./x_achse_f_spektrum_filter; 
...
xlabel('$r=\frac{<u>}{f} / m$', 'interpreter','latex');
...
if ischar(save_path)
   ...
   for a = 1:length(h)
       exportgraphics(h(a),fullfile(save_path,sprintf('spectrum_filter_%d.png', a)))
