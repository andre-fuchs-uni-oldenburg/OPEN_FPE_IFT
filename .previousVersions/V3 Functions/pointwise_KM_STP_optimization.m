...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [evaluated]=pointwise_KM_STP_optimization(evaluated,scal,increment_bin,markov,data,Fs,tol,m_data,taylor_L,test_opti,multi_point,condition,tol_point,min_events,k,save_path) 
...
fval_start  = calc_divergence(x0,y_mean_bin,x_mean_bin,P_B,P_AnB,P_AIB,markov,x_bin_not_nan,counter_A,counter_B,min_events,taylor_L,m_data,Fs,tau1,tau2); 
...
fmincon(@(x0)calc_divergence(x0,y_mean_bin,x_mean_bin,P_B,P_AnB,P_AIB,markov,x_bin_not_nan,counter_A,counter_B,min_events,taylor_L,m_data,Fs,tau1,tau2),x0,[],[],[],[],lb,ub,[],options);
disp(fval_start)
disp(fval)
...
if test_opti==1  
    plot_pointwise_KM(y,x,y_mean_bin,x_mean_bin,x_bin_not_nan,x0,x1,P_B,P_AnB,P_AIB,counter_A,counter_B,min_events,eD1,eD2,markov,fval_start,fval,tau1,tau2,m_data,Fs,taylor_L,tol,dy,increment_bin,ub,lb,save_path);
end
end