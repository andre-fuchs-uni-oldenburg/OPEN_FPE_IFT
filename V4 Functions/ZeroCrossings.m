function [Lint,lambda,lambda1,EpsNew,h]=ZeroCrossings(U,Fs,m_data,nu,low_freq,x_achse_k_spektrum_2pi,E_k,h)
if low_freq== Fs/2
    fc  = low_freq-1;
else
    fc  = low_freq;
...
[EpsNew,h]        = PostProcEps(U,m_data,Fs,nu,x_achse_k_spektrum_2pi,E_k,h);
end
...
function [EpsNew,h]=PostProcEps(U,m_data,Fs,nu,x_achse_k_spektrum_2pi,E_k,h)
% UU              = m_data;
% UUstd           = std(U);
% U_tmp1          = m_data; 
% Fs              = Fs.*2.*pi./m_data;
