...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [markov]=wilcoxon_test(data,Fs,m_data,int_L,taylor_L,diss_scale,increment_bin,save_path,f_avg, E_avg)
...
if ischar(save_path)     
    savefig(h,fullfile(save_path,'wilcoxon_test.fig'),'compact')
    for a = 1:length(h)
        exportgraphics(h(a),fullfile(save_path,sprintf('wilcoxon_test_%d.png', a)))
    end
end
tmp_ui=uicontrol('Position',[10 10 100 40],'String','Continue','Callback','uiresume(gcbf)');
uiwait(gcf);
