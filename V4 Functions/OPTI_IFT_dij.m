...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [co_IFT_opti,history]=OPTI_IFT_dij(tol_D1,tol_D2,evaluated,co_KM_opti,fitresult_D1_conf,fitresult_D2_conf,int_L,taylor_L,m_data,Fs,data,z,iter,markov,trajec,dr_ind,norm_ur,norm_r,save_path)
...
OPTI_IFT_plot(data,stp,r,rind,co_KM_opti,co_IFT_opti,evaluated,Fs,taylor_L,lb,ub,t,history,index,d11,d20,d21,d22,m_data,markov,trajec,dr_ind,z,norm_ur,norm_r,save_path)
end