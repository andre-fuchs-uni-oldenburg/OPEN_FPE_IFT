...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
function [r,S_exp_2,S_exp_3,S_exp_4,S_exp_5,S_exp_6,S_exp_7,Lam_sq_L_1,Lam_sq_L_2,Lam_sq_L_3,T_exp_3,T_exp_5,T_exp_7,exponent]=plot_struc_function(r_n,Fs,data,m_data,int_L,taylor_L,mu,D,norm_r,save_path)
...
for i=5:-1:1
    ...
    uiwait(gcf);
    if ischar(save_path)
        exportgraphics(h(i),fullfile(save_path,sprintf('structure_function_%d.png', i)))
    end
    delete(tmp_ui);
    close
end
