...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[co_KM_opti,co_KM_opti_old,co_no_opti,fitresult_D1_conf,fitresult_D2_conf]=FIT_KM(evaluated_point,increment_bin,taylor_L,Fs,m_data,markov,multi_point,condition,norm_ur,norm_r,save_path)
...
%                     (-0.36.*repmat(logspace(log10(min(y(:,1))),log10(max(y(:,1))),100).',1,100).^(-1).*repmat(linspace(min(xData),max(xData),100),100,1)),'FaceColor',[0.501960813999176 0.501960813999176 0.501960813999176],'EdgeColor',[0.501960813999176 0.501960813999176 0.501960813999176])
                ...
                title('optimized KM, optimized fit, K62','interpreter','latex');
...
%     scatter3(xData,yData,zData,'MarkerFaceColor',[0 0 0],'MarkerEdgeColor',[1 1 1])
    ...
    if ischar(save_path)
        savefig(h,fullfile(save_path,'KM_Fit.fig'),'compact')
        for a = 1:length(h)
            exportgraphics(h(a),fullfile(save_path,sprintf('KM_Fit_%d.png', a)))
        end
    end 
