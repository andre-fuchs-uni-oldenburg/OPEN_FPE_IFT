...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function OPTI_IFT_plot(data,stp,r,rind,co_KM_opti,co_IFT_opti,evaluated,Fs,taylor_L,lb,ub,t,history,index,d11,d20,d21,d22,m_data,markov,trajec,dr_ind,z,norm_ur,norm_r,save_path)
...
if ischar(save_path)
    savefig(h,fullfile(save_path,'opti_IFT.fig'),'compact')
end
for i=1:6
