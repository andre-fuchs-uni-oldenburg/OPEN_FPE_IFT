...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function plot_pointwise_KM(y,x,y_mean_bin,x_mean_bin,x_bin_not_nan,x0,x1,P_B,P_AnB,P_AIB,counter_A,counter_B,min_events,eD1,eD2,markov,fval_start,fval,tau1,tau2,m_data,Fs,taylor_L,tol,dy,increment_bin,ub,lb,save_path)
...
%% non-optimized D1, D2
P_moment = nan;
P_moment = ShortTimeProp(y_input,x_input,tau1,tau2,D1_poly,D2_poly,taylor_L,m_data,Fs);

%% optimized D1, D2
P_optimiert = nan;
P_optimiert = ShortTimeProp(y_input,x_input,tau1,tau2,D1_poly_optimiert,D2_poly_optimiert,taylor_L,m_data,Fs);%an dieser Stelle auch x_mean_bin berücksichtigen!
...
if ischar(save_path)
    savefig(h,fullfile(save_path,'KM_STP_optimization.fig'),'compact')
    for a = 1:length(h)
        exportgraphics(h(a),fullfile(save_path,sprintf('KM_STP_optimization_%d.png', a)))
    end
end
