...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[Sm,Ds,DS,r,ind_trajec,rind,dr,r_s,u,Lag,A,p,H,tmpvar,H1,H2,ur_s_tmp]=checkFT(evaluated,int_L,taylor_L,Fs,data,m_data,z,co,data_length,markov,trajec,dr_ind)
