...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function plot_increment_pdf(data,nbins,save_path,int_L,taylor_L,m_data,Fs,varargin)
...
%%    castaing
   ...
   %asymmetry   = skewness(incr1);
    ...
    legend('$u_L$','$u_\lambda$',['Cast. $\lambda^2=$',num2str(Lam_sq_L,'%1.2f')],['Cast. $\lambda^2=$',num2str(Lam_sq_l,'%1.2f')],'FontSize',18);
end
set(gca,'yScale','log') 
set(gcf, 'Color', 'w')
set(gca,'FontSize',22)
...
if ischar(save_path)
savefig(h,fullfile(save_path,'increment_pdf.fig'),'compact')
    for a = 1:length(h)
        exportgraphics(h(a),fullfile(save_path,sprintf('increment_pdf_%d.png', a)))
    end
end
close
end