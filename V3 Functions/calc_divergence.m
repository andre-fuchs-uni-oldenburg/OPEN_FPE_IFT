...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function d_M = calc_divergence(x0,y_mean_bin,x_mean_bin,P_B,P_AnB,P_AIB,markov,x_bin_not_nan,counter_A,counter_B,min_events,taylor_L,m_data,Fs,tau1,tau2)
...
% tau=markov;
P_n = ShortTimeProp(y_input,x_input,tau1,tau2,D1_poly,D2_poly,taylor_L,m_data,Fs); 
